...
| [docs/07-CDU.md](docs/07-CDU.md) | Casos de uso por perfil: flujos conversacionales, tools MCP, casos borde y notas de implementación (66 CDUs — Padre, Docente, Admin, Alumno, Cross) |
